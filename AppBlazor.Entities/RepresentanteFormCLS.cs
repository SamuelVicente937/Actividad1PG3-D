...
namespace AppBlazor.Entities
{
    public class RepresentanteFormCLS
    {
        ...
        [Range(0, int.MaxValue, ErrorMessage = "El numero de empleado debe ser positivo")]
        public int Num_Empl { get; set; }
        [Required(ErrorMessage = "El nombre es requerido")]
        [MaxLength(60, ErrorMessage = "La longitud maxima es 60 caracteres")]
        [MinLength(5, ErrorMessage = "La longitud minima es de 6 caracteres")]
        ...
        [Range(typeof(DateTime), "01/01/1980", "12/31/9999", ErrorMessage = "La fecha de contrato debe ser después de 1980")]
        public DateTime FechaContrato { get; set; }
        [Required(ErrorMessage = "La cuota es requerida")]
        [Range(0, int.MaxValue, ErrorMessage = "la cuota de empleado debe ser positivo")]
        public double Cuota { get; set; }
        [Required(ErrorMessage = "La venta es requerido")]
        [Range(0, int.MaxValue, ErrorMessage = "La venta del empleado debe ser positivo")]
